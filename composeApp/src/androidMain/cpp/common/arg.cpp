...
common_params_context common_params_parser_init(common_params &params, llama_example ex,
    ...
    add_opt(common_arg(
            {"-fa", "--flash-attn"},
            string_format("enable Flash Attention (default: %s)",
    ...
    add_opt(common_arg(
            ...
            [](common_params &params, const std::string &value) {
                /**/ if (value ==
                         "deepseek") { params.reasoning_format = COMMON_REASONING_FORMAT_DEEPSEEK; }
            else if (value ==
                     "deepseek-legacy") { params.reasoning_format = COMMON_REASONING_FORMAT_DEEPSEEK_LEGACY; }
